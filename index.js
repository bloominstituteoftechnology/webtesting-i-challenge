            ...
            if(item.type === "armor" && (item.enhancement > 5 || typeof item.enhancement === "string")) {
               if(item.enhancement < 15) {
                  ...
                  if(typeof item.enhancement === "string" && item.enhancement === "PEN") {
                     item.enhancement = "TET"
                  } else if(typeof item.enhancement === "string" && item.enhancement === "TET") {
                     item.enhancement = "TRI"
                  } else if(typeof item.enhancement === "string" && item.enhancement === "TRI") {
                     item.enhancement = "DUO"
                  } else if(typeof item.enhancement === "string" && item.enhancement === "DUO") {
                     item.enhancement = "PRI"
                  } else if(typeof item.enhancement === "string" && item.enhancement === "PRI") {
                     item.enhancement = 15
                  }
               }
            }
