...
- [x] The maximun enhancement possible is PEN.
- [x] Enhacing an armor up to 5 cannot fail.
- [x] Enhacing a weapon up to 7 cannot fail.
- [x] Enhancement level is displayed as a string with a plus sign ( + ) before the number for levels 1 to 15.
...
- [x] From +0 to +15 the enhacement is displayed using Arabic Numerals.
